...
" I keep my keymaps and settings in .vimrc for regular
" vim e.g. for remote server editing. No need to repeat
" it all here.
source ~/.vimrc
...
" Rust stuff mostly from sharksforarms.
...
Plug 'tzachar/cmp-tabnine', { 'do': './install.sh' } " AI-driven completion
" leave off?
